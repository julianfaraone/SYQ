...
__all__ = ['ILSVRCMeta', 'ILSVRC12', 'ILSVRCtiny']
...
class ILSVRCMeta(object):
    ...
    def __init__(self, dir=None):
        if dir is None:
            dir = get_dataset_path('tini_metadata')#'ilsvrc_metadata')
        self.dir = dir
        mkdir_p(self.dir)
...
class ILSVRC12(RNGDataFlow):
    def __init__(self, dir, name, meta_dir=None, shuffle=True,
            dir_structure='not original', include_bb=False):
        """
...
class ILSVRCtiny(RNGDataFlow): ######################## correct for ilcvrc12
    def __init__(self, dir, name, meta_dir=None, shuffle=True,
